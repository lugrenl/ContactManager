...
erDiagram
    ...
    contacts {
        int contact_id PK "GENERATED BY DEFAULT AS IDENTITY"
        varchar(50) name "NOT NULL"
        varchar(50) surname "NOT NULL"
        varchar(50) email "NULLABLE"
        varchar(20) phone_number "NULLABLE"
    }
    
    user_contacts {
        int user_id FK "REFERENCES users(user_id) ON DELETE CASCADE"
        int contact_id FK "REFERENCES contacts(contact_id) ON DELETE CASCADE"
...
3. Добавить функцию разлогинивания
4. Добавить тесты
```
